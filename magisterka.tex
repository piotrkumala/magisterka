...
\begin{figure}[!ht]
	\centering
	\makebox[0pt]{\includegraphics[scale=0.5]{linear.png}}
...
\begin{figure}[!ht]
	\centering
	\makebox[0pt]{\includegraphics[scale=0.5]{trees_r2.png}}
	\caption{Zmiana wyniku testu $R^2$ dla różnych głębokości drzewa}
	\label{figure:treer2}
\end{figure}
\begin{figure}[!ht]
	\centering
	\makebox[0pt]{\includegraphics[scale=0.5]{decission_tree_5.png}}
...
\begin{figure}[!ht]
	\centering
	\makebox[0pt]{\includegraphics[scale=0.5]{decission_tree_14.png}}
...
\begin{figure}[!ht]
	\centering
	\makebox[0pt]{\includegraphics[scale=0.35]{simple_rnn_neurons.png}}
...
\FloatBarrier
 \begin{figure}[!ht]
	\centering
	\makebox[0pt]{\includegraphics[scale=0.5]{simpleRNN_2.png}}
...
\FloatBarrier
 \begin{figure}[!ht]
	\centering
	\makebox[0pt]{\includegraphics[scale=0.5]{simpleRNN_64.png}}
...
\FloatBarrier
 \begin{figure}[!ht]
	\centering
	\makebox[0pt]{\includegraphics[scale=0.5]{simpleRNN_512.png}}
